...
BOOST_FIXTURE_TEST_SUITE(TestSuiteClientManager,ClientManagerFixture)
    ...
    BOOST_AUTO_TEST_CASE(ExcpetionsRegisterAndExceptionsGetClientTest) {
        ...
        BOOST_REQUIRE_THROW(CM.regiterClient("Jan","Ktos","242544",testType),ClientError);
        ...
        BOOST_REQUIRE_THROW(CM.regiterClient("Jan","Ktos","242544",nullptr),ClientError);
    ...
    BOOST_AUTO_TEST_CASE(FindClientsAndFindAllClientsTest){
        ClientManager CM(CR);
        testClient=CM.regiterClient("Jan","Ktos","242544",testType);
        testClient2=CM.regiterClient("NieJan","Kowalski","242567",testType);
