...
struct RepositoryFixture {
   ...
   // pt::ptime testEndTime = pt::second_clock::local_time()+pt::hours(50);
    ...
    RepositoryFixture() {
        ...
        testRes = std::make_shared<Reservation>(testClient,testRoom,testGuestCount,testId,testBeginTime,2,A);
        ...
        testRes2= std::make_shared<Reservation>(testClient2,testRoom2,testGuestCount2,testId2,testBeginTime,2,A);
